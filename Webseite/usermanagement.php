...
<div class="container">
	<form class="form-horizontal" role="form">
		...
		<div class="form-group form-group">
			...
			<div class="col-sm-2">
				<label for="bfneuernutzer">User erfassen</label>			
           		<a class="btn btn-block btn-success" id="bfneuernutzer" href="neuernutzer.php"><span class="glyphicon glyphicon-plus"></span> User erfassen</a>		
			</div>		
  		</div>
    </form>
</div>
